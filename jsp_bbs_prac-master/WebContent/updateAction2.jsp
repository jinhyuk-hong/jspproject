...
<body>
	<%
		...
		if(!userID.equals(stu.getUserID())){
			...
			if(request.getParameter("gradeName") == null || request.getParameter("stuList") == null || request.getParameter("gradeName").equals("") || request.getParameter("stuList").equals("")) {
				PrintWriter script = response.getWriter();
				script.println("<script>");
				...
				int result = stuDAO.update(request.getParameter("stuID"), request.getParameter("gradeName"), request.getParameter("stuList"));
				if(result == -1){
					PrintWriter script = response.getWriter();
					script.println("<script>");
